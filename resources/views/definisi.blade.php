...
<?php
        ...
        $array = array("abate"=> "subside, or moderate",
...
<div class="container align-items-center bg-light rounded" style="color: black;">
        <div class="row align-items-center "  style="margin-top: 2%;">
            <div class="col-6"  style="border-right: 1px solid black; padding: 20px;">
                <div class="card">
                    <h5 class="card-header"> Kata </h5>
                    <div class="card-body">
                        <h1> <?php echo $kata; ?> </h1>
                </div>
            </div>
            ...
            <div class="col-6 align-items-center " style="margin-bottom: 3%; padding: 20px;">
                <!-- Cari kata -->
                <div class="row">
                    <div class="col">
                        <div class="card">
