...
<head>
    ...
    <title>Kamus GRE</title>
</head>
<body class="bg-primary text-white">
    <button onclick="topFunction()" id="myBtn" title="Go to top">Kembali</button>
    ...
    <div class="container bg-light rounded" style="color: black;">
        <div class="row">
            <div class="col-2"  style="border-right: 1px solid black; ">
                <p>
                  <b>  Silahkan cari kata </b>
                </p>
                  <!-- List Kata (Collapse) -->
                  <button class="btn btn-warning" data-toggle="collapse" data-target="#demo" style="color: white;">List Kata</button>

                    <div id="demo" class="collapse" style="padding: 20px;";>
                        <p>Abate,Aberrant, Abeyance, Abscond, Abstemious, Admonish, Adulterate, Aesthetic, Aggregate, Alacrity,
                            Alleviate, Amalgamate, Ambiguous, Ambivalence, Ameliorate, Anachronism, Analogous, Anarchy, Anomalous,
            ...
            <div class="col-5" style="border-right: 1px solid black; margin-bottom: 3%;">
                <form id="myForm">
                <!-- Cari kata -->
                <div class="row">
                    <div class="col">
                        <input class="input"  type="text" placeholder="pilih kata yang ada di list.." name="kata" id="input-kata">
                        <div style="margin-top: 2%; ">
                            <button  type="button" class="btn btn-primary"  id="btn-cari">Lihat definisi</button>
                            <button style="margin-left: 2%;" onclick="hapus()" type="reset" id="reset" class="btn btn-danger"> Hapus </button>
                        </div>
                    </div>
                 </div>
            </div>
            ...
            <div class="col-5">
                    <!-- Definisi kata-->
                    <div style="margin-top: 2%;">
                        <h3> Hasil Definisi</h3>
                        <p class="bg-info text-white rounded" id="definisi"> </p>
                </div>
            </form>
            </div>
        </div>
